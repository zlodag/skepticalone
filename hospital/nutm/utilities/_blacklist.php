...
$blacklist = [
    ...
    [978,68], // Cardio Thoracic: Clinical Admin AM [0800 - 1230] (PARKINSON Grant)
    [765,53], // Cardiology: CLN AM - Cardiology [0800 - 1200] (PASUPATI Sanjeevan)
    [903,104], // Cardiology: Admin-Non Clinical AM [0800 - 1200] (FISHER Raewyn)
    [907,105], // Cardiology: Admin-Non Clinical AM [0800 - 1200] (HEALD Spencer)
    [1516,102], // General Surgery: CLN BCC AM - Consultant [0800 - 1200] (To Be Advised)
    [1560,127], // General Surgery: Admin-NonClinical AM [0800 - 1200] (GRUNEWALD Bernd)
    [1557,147], // General Surgery: Trauma Ward Round AM [0800 - 1200] (CHRISTEY Grant)
    [937,135], // Medicine: Orange Ward AM [0800 - 1230] (GRAY Erana)
    [1064,146], // Medicine: General Medicine Admin-Non Clinical AM & PM [0800 - 1700] (REEVE Paul)
    [986,186], // Medicine: Gastro Admin-NonClinical AM [0800 - 1200] (BROOKER Jim)
    [988,187], // Medicine: Gastro Admin-NonClinical AM [0800 - 1200] (WEILERT Frank)
    [1578,79], // Neurosurgery: Ward AM [0800 - 1200] (HUSSAIN Zakier)
    [1653,80], // Neurosurgery: Clinical-Non Clinical Admin AM [0800 - 1200] (MUTHU Thirayan)
    [1664,81], // Neurosurgery: Clinical-Non Clinical Admin AM [0800 - 1200] (GAN Peter)
    [1154,53], // Obs and Gynae: On Duty: AM - Consultant [0800 - 1230] (HASTIE Stewart)
    [984,149], // Obs and Gynae: Taumarunui [0800 - 1700] (LIN Sylvia)
    [527,298], // Obs and Gynae: Gynae CLN 2 AM SMO [0900 - 1230] (RAMAN Kannan)
    [1317,82], // Oncology: Clinic Haem HP (AM) [0800 - 1200] (PULLON Humphrey)
    [1754,164], // Oncology: Clinical-Non Clinical Admin Haem HG (AM) [0800 - 1200] (GOODMAN Hugh)
    [1757,170], // Oncology: Clinical-Non Clinical Admin Haem NG (AM) [0800 - 1200] (GAVRILOVA Natalia)
    [1399,181], // Oncology: Haematology Clinics - Reg [0800 - 1700] (RUKA Myra)
    [1400,182], // Oncology: Haematology Clinics - Reg [0800 - 1700] (SEKARAN Usha Nair Chandra)
    [1722,188], // Oncology: Clinic Med Onc IK (AM) [0800 - 1200] (Cancel)
    [1724,192], // Oncology: Clinic Med Onc MK (AM) [0800 - 1200] (KUPER Marion)
    [1727,198], // Oncology: Clinic Med Onc EE (AM) [0800 - 1200] (EPNER Elliot)
    [1769,200], // Oncology: Clinic Med Onc AT (AM) [0800 - 1200] (TAN Alvin)
    [1738,210], // Oncology: Clinical-Non Clinical Admin Med Onc AS (AM) [0800 - 1200] (SRIVASTAVA Archana)
    [1739,212], // Oncology: Clinical-Non Clinical Admin Med Onc LN (AM) [0800 - 1200] (NAGLE Lawrence)
    [1702,235], // Oncology: Clinic Radiation Oncology CD (AM) [0800 - 1200] (DE GROOT Charles)
    [1703,239], // Oncology: Clinic Radiation Oncology MS (AM) [0800 - 1200] (SEEL Matthew)
    [1704,241], // Oncology: Clinic Radiation Oncology AA (AM) [0800 - 1200] (Cancel)
    [1555,47], // Ophthalmology: CLN [A] AM - Consultant [0800 - 1200] (CUNNINGHAM William)
    [1583,52], // Ophthalmology: CLN [D] AM - Registrar [0800 - 1200] (BHIKOO Riyaz)
    [1592,53], // Ophthalmology: CLN [D] AM - Registrar [0800 - 1200] (YAP Joel)
    [1496,105], // Ophthalmology: Admin AM [0800 - 1200] (NG Stephen)
    [1436,66], // Orthopaedics: CLN B AM - Consultant [0800 - 1200] (MACMICHAEL Douglas)
    [1141,189], // Paediatrics: CLN Paeds Medical AM - SMO [0800 - 1230] (SINGH Deepika)
    [1298,190], // Paediatrics: CLN Paeds Medical AM - SMO [0800 - 1230] (GOLDSMITH John)
    [1299,191], // Paediatrics: CLN Paeds Medical AM - SMO [0800 - 1230] (GRAHAM David)
    [1502,192], // Paediatrics: CLN Paeds Medical AM - SMO [0800 - 1230] (SADANI Sneha)
    [1370,271], // Paediatrics: Paed Surgical Reg - Clinic (or OT) [0730 - 1630] (LIYANAGE Anuradha)
    [1372,67], // Plastics: CLN Plastics OPD AM - Reg [0800 - 1200] (EMANUEL Henry)
    [1403,86], // Plastics: CLN Plastics Thames - Consultant [0800 - 1700] (YANG Arthur)
    [1073,42], // Rehabilitation: Clinics AM [0800 - 1200] (KAPLAN Michael)
    [902,71], // Rehabilitation: Clinics Satelite [0800 - 1700] (GOVENDER Siva)
    [1146,73], // Rehabilitation: Clinics Thames [0800 - 1700] (SAMAD Sha)
    [855,56], // Renal: Haemodialysis Clinic [0900 - 1200] (SIZELAND Peter)
    [989,54], // Respiratory: Ward Round AM [0800 - 1200] (BHIKOO Zaheer)
    [1060,63], // Respiratory: Respiratory CLN AM [0800 - 1200] (WONG Janice)
    [1564,85], // Urology: MCC23 -Surgeon [0800 - 1700] (HOLMES Michael)
    [900,92], // Vascular: MCC02 - Vascular Surgeon [0800 - 1700] (HOLDAWAY Chris)
    [1557,59], // ENT: CLN [B] AM - Reg [0800 - 1200] (CHAN Benjimen)
    [1604,149], // General Surgery: Urology On Duty: Registrar [0730 - 2230] (SALUJA Manmeet)
